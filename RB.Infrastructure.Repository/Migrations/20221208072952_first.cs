        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignupMemberId = table.Column<int>(type: "int", nullable: false),
                    HostedRidesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JoinRide", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JoinRide_HostedRides_HostedRidesId",
                        column: x => x.HostedRidesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<bool>(type: "bit", nullable: false),
                    HostedRidesId = table.Column<int>(type: "int", nullable: false),
                    JoinRideId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JoinRequestQueue", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JoinRequestQueue_HostedRides_HostedRidesId",
                        column: x => x.HostedRidesId,
                        principalTable: "HostedRides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JoinRequestQueue_JoinRide_JoinRideId",
                        column: x => x.JoinRideId,
                        principalTable: "JoinRide",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinRequestQueue_HostedRidesId",
                table: "JoinRequestQueue",
                column: "HostedRidesId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinRequestQueue_JoinRideId",
                table: "JoinRequestQueue",
                column: "JoinRideId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinRide_HostedRidesId",
                table: "JoinRide",
                column: "HostedRidesId");
