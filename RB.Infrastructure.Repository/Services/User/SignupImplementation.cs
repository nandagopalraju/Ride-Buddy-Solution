...
namespace RB.Infrastructure.Repository.Services.User
{
    public class SignupImplementation : ISignupValidations
    {
        private IConfiguration _config;

        public SignupImplementation(IConfiguration config)
        {
